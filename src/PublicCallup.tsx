...
export default function PublicCallup(){
 ...
 {data.closed?<section className="callups-card"><h2>Convocatoria cerrada</h2><p>El plazo de respuesta ha terminado. Para cualquier cambio, contacta con el entrenador.</p></section>:<section className="callups-card"><h2>Confirma por tu hijo</h2><p>Busca su dorsal y nombre. Si no puede asistir, puedes indicar el motivo; solo lo verá el entrenador.</p>
