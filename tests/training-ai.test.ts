...
test('AI training response must be structured and match requested context',()=>{
 const visual={board:[{kind:'attacker',x:25,y:40,label:'1'},{kind:'defender',x:55,y:50,label:'1'},{kind:'ball',x:28,y:42}],actions:[{kind:'pass',from:{x:25,y:40},to:{x:70,y:60},order:1}]};
